/**
 * State Management for GID
 *
 * Tracks extraction state for incremental updates and version history.
 */
...
export function createStateManager(gidDir: string): StateManager {
...
export function diffGraphs(
  ...
  // Simple edge count comparison (detailed edge diff is complex)
